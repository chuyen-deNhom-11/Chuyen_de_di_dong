...
public class BrowseTableFragment extends Fragment {
    ...
    private void setAdpater(){
        ...
        depositMoneyAdapter= new DepositMoneyAdapter(context,R.layout.fragment_censor,bookingTableModels,"BrowseTableFragment");
